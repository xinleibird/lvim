if vim.g.neovide then
  -- Font
  -- vim.opt.guifont = "JetBrainsMono_Nerd_Font_Mono:h13"
  -- vim.opt.guifont = "FiraCode_Nerd_Font_Mono_Light:h13:#h-none"
  vim.opt.guifont = "FiraCode_Nerd_Font_Mono_Light:h13"
  ...
  -- Scaling font without font size
  ...
  -- For keyboard Super Command Option key, macOs default true
  ...
  -- Cursor vfx mode
  -- "railgun", "torpedo","pixiedust", "sonicboom", "wireframe", "ripple", default is ""
